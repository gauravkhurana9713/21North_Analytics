  ...
  controlPanelSections: [_chartControls.sections.legacyRegularTime, {
    ...
    controlSetRows: [[{
      ...
      config: {
        ...
        default: 'France',
        choices: ['Belgium', 'Brazil', 'Bulgaria', 'China', 'Egypt', 'France', 'Germany', 'India', 'Iran', 'Italy', 'Japan', 'Korea', 'Liechtenstein', 'Morocco', 'Myanmar', 'Netherlands', 'Portugal', 'Russia', 'Singapore', 'Spain', 'Switzerland', 'Thailand', 'Timorleste', 'Uk', 'Ukraine', 'Uruguay', 'Usa', 'Zambia'].map(s => [s, s]),
