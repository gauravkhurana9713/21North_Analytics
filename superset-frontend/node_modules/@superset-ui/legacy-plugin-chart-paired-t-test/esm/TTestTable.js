...
class TTestTable extends React.Component {
  ...
  render() {
    ...
    const columns = groups.map((group, i) => /*#__PURE__*/React.createElement(Th, {
      key: i,
      column: group
    }, group));
    const numGroups = groups.length; // Columns for p-value, lift-value, and significance (true/false)

    columns.push( /*#__PURE__*/React.createElement(Th, {
      key: numGroups + 1,
      column: "pValue"
    }, "p-value"));
    columns.push( /*#__PURE__*/React.createElement(Th, {
    ...
    const rows = data.map((entry, i) => {
      ...
      values.push( /*#__PURE__*/React.createElement(Td, {
        key: numGroups + 1,
    ...
    return /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("h3", null, metric), /*#__PURE__*/React.createElement(Table, {
      className: "table",
      id: `table_${metric}`,
      sortable: sortConfig
    }, /*#__PURE__*/React.createElement(Thead, null, columns), rows));
  }
