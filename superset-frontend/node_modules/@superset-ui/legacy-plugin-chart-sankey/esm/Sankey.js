...
function Sankey(element, props) {
  ...
  function onmouseover(d) {
    tooltip.html(() => getTooltipHtml(d)).transition().duration(200).style('left', `${d3.event.offsetX + 10}px`).style('top', `${d3.event.offsetY + 10}px`).style('position', 'absolute').style('opacity', 0.95);
  }
