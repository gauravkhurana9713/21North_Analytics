...
function DataTable({
  ...
  }, [initialHeight, initialWidth, wrapperRef, hasPagination, hasGlobalControl, paginationRef, resultsSize, JSON.stringify(serverPaginationData)]);
  ...
  const getNoResults = () => /*#__PURE__*/_react.default.createElement("div", {
  ...
  }, noResults)))); // force update the pageSize when it's been update from the initial state
  ...
  })) : null)) : null, wrapStickyTable ? wrapStickyTable(renderTable) : renderTable(), hasPagination && resultPageCount > 1 ? /*#__PURE__*/_react.default.createElement(_Pagination.default, {
    ref: paginationRef,
