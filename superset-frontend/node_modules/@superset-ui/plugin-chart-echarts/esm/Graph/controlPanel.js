...
const controlPanel = {
  controlPanelSections: [sections.legacyRegularTime, {
    ...
    expanded: true,
    controlSetRows: [['color_scheme'], [/*#__PURE__*/React.createElement("h1", {
      className: "section-header"
    }, t('Legend'))], [showLegendControl], [legendTypeControl, legendOrientationControl], [legendMarginControl, noopControl], [/*#__PURE__*/React.createElement("h1", {
      className: "section-header"
    }, t('Layout'))], [{
      name: 'layout',
      config: {
