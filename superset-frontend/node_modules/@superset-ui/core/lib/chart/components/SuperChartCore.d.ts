...
export default class SuperChartCore extends React.PureComponent<Props, {}> {
    ...
    processChartProps: import("reselect").OutputSelector<{
        ...
        transformProps?: ((x: ChartProps<import("../types/Base").PlainObject>) => import("../types/Base").PlainObject) | undefined;
        postTransformProps?: ((x: import("../types/Base").PlainObject) => import("../types/Base").PlainObject) | undefined;
    }, import("../types/Base").PlainObject, (res1: ChartProps<import("../types/Base").PlainObject>, res2: ((x: ChartProps<import("../types/Base").PlainObject>) => ChartProps<import("../types/Base").PlainObject>) | undefined, res3: ((x: ChartProps<import("../types/Base").PlainObject>) => import("../types/Base").PlainObject) | undefined, res4: ((x: import("../types/Base").PlainObject) => import("../types/Base").PlainObject) | undefined) => import("../types/Base").PlainObject>;
    /**
     * memoized function so it will not recompute
     * and return previous value
     * unless one of
