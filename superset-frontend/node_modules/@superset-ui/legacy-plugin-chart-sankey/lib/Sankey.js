...
function Sankey(element, props) {
  ...
  function onmouseover(d) {
    tooltip.html(() => getTooltipHtml(d)).transition().duration(200).style('left', `${_d.default.event.offsetX + 10}px`).style('top', `${_d.default.event.offsetY + 10}px`).style('position', 'absolute').style('opacity', 0.95);
  }
