...
const controlPanel = {
  controlPanelSections: [_chartControls.sections.legacyRegularTime, {
    ...
    expanded: true,
    controlSetRows: [['color_scheme'], [/*#__PURE__*/_react.default.createElement("h1", {
      className: "section-header"
    }, (0, _core.t)('Legend'))], [_controls.showLegendControl], [_controls.legendTypeControl, _controls.legendOrientationControl], [_controls.legendMarginControl, noopControl], [/*#__PURE__*/_react.default.createElement("h1", {
      className: "section-header"
    }, (0, _core.t)('Layout'))], [{
      name: 'layout',
      config: {
