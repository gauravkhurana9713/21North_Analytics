...
import { filterNulls, jsColumns, jsDataMutator, jsTooltip, jsOnclickHref, fillColorPicker, strokeColorPicker, filled, stroked, extruded, viewport, mapboxStyle } from '../../utilities/Shared_DeckGL';
export default {
  controlPanelSections: [sections.legacyRegularTime, {
    ...
    }, null], ['row_limit', filterNulls], ['adhoc_filters']]
  }, {
    label: t('Map'),
