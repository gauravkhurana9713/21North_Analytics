...
var _buildQueryObject = require("./buildQueryObject");
...
function extractQueryFields(formData, aliases) {
  ...
  if (includeTime && !columns.includes(_buildQueryObject.DTTM_ALIAS)) {
    columns.unshift(_buildQueryObject.DTTM_ALIAS);
  }

  return {
    columns: (0, _utils.removeDuplicates)(columns.filter(x => typeof x === 'string' && x)),
