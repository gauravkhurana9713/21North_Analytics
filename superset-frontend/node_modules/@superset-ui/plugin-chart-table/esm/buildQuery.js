 ...
 * under the License.
 */
import { buildQueryContext, getMetricLabel, QueryMode, removeDuplicates, ensureIsArray } from '@superset-ui/core';
...
const buildQuery = (formData, options) => {
  ...
  return buildQueryContext(formDataCopy, baseQueryObject => {
    var _options$extras, _options$extras$cache, _options$extras2, _options$extras2$cach, _options$hooks2;
    ...
    if (formDataCopy.server_pagination) {
      var _formDataCopy$extra_f, _formDataCopy$extra_f2, _formDataCopy$extra_f3, _formDataCopy, _formDataCopy$extra_f4, _formDataCopy$extra_f5;

      const rowLimit = (_formDataCopy$extra_f = formDataCopy.extra_form_data) == null ? void 0 : (_formDataCopy$extra_f2 = _formDataCopy$extra_f.custom_form_data) == null ? void 0 : _formDataCopy$extra_f2.row_limit;
      moreProps.row_limit = rowLimit != null ? rowLimit : formDataCopy.server_page_length;
      moreProps.row_offset = (_formDataCopy$extra_f3 = (_formDataCopy = formDataCopy) == null ? void 0 : (_formDataCopy$extra_f4 = _formDataCopy.extra_form_data) == null ? void 0 : (_formDataCopy$extra_f5 = _formDataCopy$extra_f4.custom_form_data) == null ? void 0 : _formDataCopy$extra_f5.row_offset) != null ? _formDataCopy$extra_f3 : 0;
    }
